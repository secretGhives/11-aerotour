		  ...
		  <table class="tableOne" width="100%"  border="1" cellpadding="0" cellspacing="1"> 
		    <tr> 
		      ...
		      <td class="coloured" colspan="3">&nbsp;True Air Speed
		        <input name="tas" class="inputs" type="integer" id="tas" size="3" value='110' />Kts</td> 
		    ...
		    <tr> 
		      ...
		      <th>Squawk</th>
				...
				<tr>
					...
					<td <?= $rowClass ?> align="center"><?php if ($number < count($route)-1 ): ?><input onchange="calcWindDirVelocity($(this), <?=$number?>);" name="windVel" class="inputs windVel" type="text" id="windVel-<?= $number?>" size="6" value="000/00" /><?php endif; ?></td>
					<td <?= $rowClass ?> align="center"><?php if ($number < count($route)-1 ): ?><input name="magVar" type="text" class="inputs magVar" size="4" maxlength="4" value='0' readonly="readonly" /><?php endif; ?></td>
